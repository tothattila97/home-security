...
public class WifiP2PActivity extends AppCompatActivity implements WifiP2pManager.ChannelListener, DeviceListFragment.DeviceActionListener {

    public static final String TAG1 = "Wifi-Direct Demo";
        ...
        switch (item.getItemId()) {
            case R.id.atn_direct_enable:
                if (manager != null && channel != null) {
                    ...
                    Log.e(TAG1, "channel or manager is null");
                }
                return true;
    ...
    public void disconnect() {
        ...
        manager.removeGroup(channel, new WifiP2pManager.ActionListener() {
            @Override
            public void onFailure(int reasonCode) {
                Log.d(TAG1, "Disconnect failed. Reason :" + reasonCode);
            }
            @Override
            public void onSuccess() {
